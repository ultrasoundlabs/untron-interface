...
export const landing: LandingDictionary = {
  ...
  meta: {
    ...
    description:
      'Переводите USDT и USDC между Tron и крупными EVM-сетями с UX без предоплаты газа, низкими комиссиями и аудированными смарт-контрактами.',
    keywords:
  ...
  nav: {
    ...
    languageLabel: 'Язык',
    toggleThemeLabel: 'Переключить цветовую тему',
  },
  hero: {
    eyebrow: 'Некастодиальный мост стейблкоинов',
    title: 'Переводите USDT и USDC между Tron и EVM-сетями без биржевых рисков.',
    description:
  ...
  stats: [
    ...
    { value: 'Аудировано', label: 'Контракты проверены и прошли независимый аудит' },
  ],
  audiences: {
    ...
    cards: [
      ...
      },
      {
        ...
        description:
          'Перемещайте объём между Tron и EVM с меньшими зависимостями, чем при переводах через CEX.',
        ctaLabel: 'Связаться',
  ...
  fees: {
    ...
    rows: [
      ...
      },
      {
        service: 'Symbiosis',
        received: '$94.00',
        notes: 'Дополнительные затраты на газ контрактов на стороне Tron',
      },
      {
        service: 'Bridgers',
        received: '$94.00',
    ...
    focusBullets: [
      ...
      'UX моста с минимумом лишних шагов',
      'Кроссчейн-расчёт с прозрачным статусом',
      'Без зависимости от централизованных аккаунтов и их инфраструктуры',
    ],
  ...
  security: {
    ...
    bullets: [
      ...
      'Контракты для ключевых путей протокола прошли независимый аудит.',
  ...
  faq: {
    ...
    items: [
      ...
      },
      {
        ...
        answer:
          'Поддерживаемые маршруты оптимизированы под UX без газа, поэтому заранее пополнять токены для газа часто не нужно.',
      },
      {
