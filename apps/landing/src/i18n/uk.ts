...
export const landing: LandingDictionary = {
  ...
  meta: {
    ...
    description:
      'Переміщуйте USDT та USDC між Tron і основними EVM-мережами з UX без газу, низькими комісіями та аудитованими смартконтрактами.',
    keywords:
  ...
  stats: [
    ...
    { value: 'Аудитовано', label: 'Контракти перевірені та формально верифіковані' },
  ],
  audiences: {
    ...
    cards: [
      {
        label: 'Користувачі',
        title: 'Міст з будь-якої біржі або гаманця',
        description:
      ...
      },
      {
        ...
        description:
          'Переміщуйте обсяги між Tron та EVM з меншими залежностями, ніж у CEX-рейлів.',
  ...
  fees: {
    ...
    footnote:
      'Цифри наведені для орієнтиру, не обіцянка. Перед відправкою перевірте живу котировку в bridge.',
    ...
    focusBullets: [
      ...
      'Без залежності від централізованих акаунтних рейлів',
    ],
    focusCta: 'Відкрити живу котировку',
  },
  chains: {
  ...
  security: {
    ...
    bullets: [
      ...
      'Аудитовані та формально верифіковані контракти для ключових шляхів протоколу.',
  ...
  finalCta: {
    title: 'Готові зробити bridge?',
    description:
      'Відкрийте застосунок, отримайте живу котировку та перемістіть стейблкоїни між Tron і EVM-мережами вже зараз.',
